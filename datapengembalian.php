      ...
      <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
        ...
        <form action="" method="post">
          ...
          <select name="pilih">
            ...
            <option value="jumlah_denda">Jumlah Denda</option>
...
<?php
   ...
   if (isset($_POST['cari'])){
    ...
    $tampil = mysqli_query($koneksi, "select * from pengembalian where $pilih like '%$tekscari%'");
}else {
...
<tr>
                ...
                <td><button type="button" class="btn btn-block btn-default btn-sm"><?php echo"<a href='deletepengembalian.php?id_peminjaman=$row[id_peminjaman]'>Delete</a>"; ?></button></td>
