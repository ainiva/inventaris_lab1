...
<?php
   ...
   if (isset($_POST["ok"]))
   {
    ...
    $simpan=mysqli_query($koneksi, "insert into pengembalian set 
    ...
    <div class="container">
      <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
        <div class="text-center">
            <h2>Form Input Data Pengembalian</h2>
       <form method="post" action="">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="terlambat" name="terlambat">
        </div>
        <div class="form-group">
            <label><b>Jumlah Denda</b></label>
            <input type="text" class="form-control" placeholder="jumlah denda" name="jumlah denda">
        </div><br>
