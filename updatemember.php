    ...
    <div class="container">
      <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
        <div class="text-center">
            <h2>Form Update Data Member </h2>
       <form method="post" action="">
        <?php
        $tampil=mysqli_query($koneksi,"select * from member where id_member='$_GET[id_member]'");
        ...
        <div class="form-group">
            ...
            <input value="<?php echo $row['no_hp'];?>" type="text" class="form-control" placeholder="no_hp" name="no_hp">
        </div><br>
